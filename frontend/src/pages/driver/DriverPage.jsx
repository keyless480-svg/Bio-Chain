...
const INITIAL_TASKS = [
  {
    ...
    type: 'pickup',
    label: 'Ambil Muatan FTL',
    location: 'Gudang Konsolidasi (Hub) — Tuban',
    address: 'Jl. Raya Tuban-Bojonegoro KM 12, Tuban',
    payload: '8.2 Ton Tongkol (Kadar air 18%)',
    eta: '25 Menit',
  ...
  },
  {
    ...
    status: 'pending',
    type: 'dropoff',
    label: 'Antar ke Pabrik (Sentral)',
    location: 'Biorefinery Utama — Kawasan Industri',
    address: 'Jl. Industri Gresik, Gresik',
    payload: '8.2 Ton → Ekstraksi Bioetanol',
    eta: '1 Jam 45 Menit',
